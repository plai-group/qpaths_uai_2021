...
in the `smc_samplers` module. For instance::
    ...
    from src.particles import smc_samplers as ssp
...
Then, the algorithm may be set and run as follows::
    ...
    from src.particles import nested
...
from src.particles import utils
from src.particles.resampling import log_sum_exp_ab as log_sum_exp
from src.particles import smc_samplers as smc
